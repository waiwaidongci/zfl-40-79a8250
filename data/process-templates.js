...
const dbPath = join(__dirname, "process-templates.json");
      ...
      steps: [
        {
          ...
          name: "涂布",
          order: 1,
          description: "在洁净的玻璃板上均匀涂布感光液",
          requiredFields: ["note"],
          optionalFields: ["chemicalBatch", "developStatus"],
          allowSkip: true,
        ...
        },
        {
          ...
          name: "晾干",
          order: 2,
          description: "在避光通风处自然晾干至完全干燥",
          requiredFields: ["note"],
          optionalFields: ["developStatus"],
          allowSkip: true,
        ...
        },
        {
          ...
          name: "曝光",
          order: 3,
          description: "使用紫外光源进行接触印相曝光",
          requiredFields: ["exposure", "note"],
          optionalFields: ["developStatus"],
          allowSkip: false,
        ...
        },
        {
          ...
          name: "冲洗",
          order: 4,
          description: "流水冲洗去除未反应的感光液，直至水流清澈",
          requiredFields: ["waterSource", "note"],
          optionalFields: ["developStatus", "defect", "repair"],
          allowSkip: false,
          targetStatus: "冲洗中",
        ...
        },
        {
          ...
          name: "复晒",
          order: 5,
          description: "冲洗后再次曝光加深色调",
          requiredFields: ["note"],
          optionalFields: ["exposure", "developStatus", "defect", "repair"],
          allowSkip: true,
        ...
        },
        {
          ...
          name: "入盒",
          order: 6,
          description: "完全干燥后放入指定存放盒位",
          requiredFields: ["box", "note"],
          optionalFields: ["developStatus", "defect", "repair"],
          allowSkip: false,
          targetStatus: "待入盒",
...
async function saveTemplates(db) {
